...
| Fuel properties | bulk_density (kg/m³), fuel_load (kg/m²), percent_cover (%), SAVR (1/m), live_fraction | in the NetCDF |
...
- **Fuel moisture (P2)** and some P3 properties are not yet populated (roadmap below).
